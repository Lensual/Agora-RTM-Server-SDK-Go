...
const (
	 ...
	 * Leave.
	 */
	RTM_LINK_OPERATION_LEAVE RTM_LINK_OPERATION = C.RTM_LINK_OPERATION_LEAVE
	/**
	 * Server reject
	 */
	 ...
	 * Network change
	 */
	RTM_LINK_OPERATION_NETWORK_CHANGE RTM_LINK_OPERATION = C.RTM_LINK_OPERATION_NETWORK_CHANGE
)
...
const (
	 ...
	 */
	RTM_SERVICE_TYPE_NONE RTM_SERVICE_TYPE = C.RTM_SERVICE_TYPE_NONE
	/**
	 * The basic functionality of rtm service.
	 */
	RTM_SERVICE_TYPE_MESSAGE RTM_SERVICE_TYPE = C.RTM_SERVICE_TYPE_MESSAGE
	/**
	 * The advanced functionality of rtm service.
	 */
	RTM_SERVICE_TYPE_STREAM RTM_SERVICE_TYPE = C.RTM_SERVICE_TYPE_STREAM
)
...
const (
	 ...
	 */
	RTM_ERROR_SERVICE_NOT_SUPPORTED RTM_ERROR_CODE = C.RTM_ERROR_SERVICE_NOT_SUPPORTED
	/**
	 * -10023: This login operation stopped by a new login operation or logout operation.
	 */
	RTM_ERROR_LOGIN_CANCELED RTM_ERROR_CODE = C.RTM_ERROR_LOGIN_CANCELED
	/**
	 * -10024: The private config is invalid, set private config should both set serviceType and accessPointHosts.
	 */
	RTM_ERROR_INVALID_PRIVATE_CONFIG RTM_ERROR_CODE = C.RTM_ERROR_INVALID_PRIVATE_CONFIG
	/**
	 * -10025: Perform operation failed due to RTM service is not connected.
	 */
	RTM_ERROR_NOT_CONNECTED RTM_ERROR_CODE = C.RTM_ERROR_NOT_CONNECTED
	/**
	 * -10026: Renew token timeout.
	 */
	RTM_ERROR_RENEW_TOKEN_TIMEOUT RTM_ERROR_CODE = C.RTM_ERROR_RENEW_TOKEN_TIMEOUT
	 ...
	 */
	RTM_ERROR_CHANNEL_JOIN_CANCELED RTM_ERROR_CODE = C.RTM_ERROR_CHANNEL_JOIN_CANCELED
	/**
	 * -11035: The message receiver is offline but the message store in history succeeded.
	 */
	RTM_ERROR_CHANNEL_RECEIVER_OFFLINE_BUT_STORE_SUCCEEDED RTM_ERROR_CODE = C.RTM_ERROR_CHANNEL_RECEIVER_OFFLINE_BUT_STORE_SUCCEEDED
	/**
	 * -11036: The message receiver is offline and the message store in history failed.
	 */
	RTM_ERROR_CHANNEL_RECEIVER_OFFLINE_AND_STORE_FAILED RTM_ERROR_CODE = C.RTM_ERROR_CHANNEL_RECEIVER_OFFLINE_AND_STORE_FAILED
	/**
	 * -11037: The message delivered successfully but store in history failed.
	 */
	RTM_ERROR_CHANNEL_MESSAGE_DELIVERED_BUT_STORE_FAILED RTM_ERROR_CODE = C.RTM_ERROR_CHANNEL_MESSAGE_DELIVERED_BUT_STORE_FAILED
	 ...
	 */
	RTM_ERROR_HISTORY_OPERATION_FAILED RTM_ERROR_CODE = C.RTM_ERROR_HISTORY_OPERATION_FAILED
	/**
	 * -15002: The timestamp is invalid.
	 */
	RTM_ERROR_HISTORY_INVALID_TIMESTAMP RTM_ERROR_CODE = C.RTM_ERROR_HISTORY_INVALID_TIMESTAMP
	/**
	 * -15003: The history operation timeout.
	 */
	RTM_ERROR_HISTORY_OPERATION_TIMEOUT RTM_ERROR_CODE = C.RTM_ERROR_HISTORY_OPERATION_TIMEOUT
	/**
	 * -15004: The history operation is not permitted.
	 */
	RTM_ERROR_HISTORY_OPERATION_NOT_PERMITTED RTM_ERROR_CODE = C.RTM_ERROR_HISTORY_OPERATION_NOT_PERMITTED
	/**
	 * -15005: The history service not available.
	 */
	RTM_ERROR_HISTORY_NOT_AVAILABLE RTM_ERROR_CODE = C.RTM_ERROR_HISTORY_NOT_AVAILABLE
)
...
const (
	 ...
	 */
	RTM_CONNECTION_CHANGED_CERTIFICATION_VERIFY_FAILURE RTM_CONNECTION_CHANGE_REASON = C.RTM_CONNECTION_CHANGED_STREAM_CHANNEL_NOT_AVAILABLE
	/**
